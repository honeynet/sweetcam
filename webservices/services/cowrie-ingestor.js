  ...
  const start = () => {
    ...
    rl.on('line', async (line) => {
      ...
      try {
        ...
        // Log to service_logs table (general service logs)
        await databaseLogger.logEvent(mapped);
        
        // Also log to cowrie_service_logs table (cowrie-specific logs)
        await databaseLogger.writeCowrieLog(mapped);
      } catch (e) {
